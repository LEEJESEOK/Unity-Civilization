...
public class TechnologyManager : Singleton<TechnologyManager>
{
    ...
    void SaveTechnologies()
    {
        ...
        technologies.Add(new Technology(TechnologyId.ARCHERY, "Archery", "궁술", 50, null, new List<TechnologyId> { TechnologyId.ANIMAL_HUSBANDRY }));

        technologies.Add(new Technology(TechnologyId.MASONRY, "Masonry", "석조 기술", 80, null, new List<TechnologyId> { TechnologyId.MINING }));
        technologies.Add(new Technology(TechnologyId.BRONZE_WORKING, "Bronze Working", "청동 기술", 80, null, new List<TechnologyId> { TechnologyId.MINING }));
        ...
        technologies.Add(new Technology(TechnologyId.APPRENTICESHIP, "Apprenticeship", "도제제도", 360, null, new List<TechnologyId> { TechnologyId.CURRENCY, TechnologyId.HORSEBACK_RIDING }));
